...
;;(`keyboard-quit (message "keyboard=qffgguitkdjffk"))
;;(`evil-normal-state (message "normal-state"))
...
layers configuration."
  ...
  ; remoe cua mode, it fucks with evil-visual-block
  ;(cua-mode)
  (simpleclip-mode 1)
  ...
  ;; Rust
  (require 'racer)
  (setq racer-cmd "/Users/terhechte/.cargo/bin/racer")
  (setq racer-rust-src-path "/Users/terhechte/Development/Rust/rust-1.9.0/src")
  ...
  (global-set-key (kbd "C-1") 'flymake-popup-current-error-menu)
